...
function IndividualLesson(props) {
  ...
  <h1 className="h1-IndividualLesson">What are {lesson.Lesson_title}?</h1>
            <p>{lesson.what_are}</p>
         <div
            ...
            <h3>Quiz</h3>
            <p>
              Test your knowledge of {lesson.lesson_title} with our<Link className="individuallesson-link" to={props.gameUrl}> QUIZ! </Link>{" "}
            </p>
            <br />
            </div>
        ))}
